...
static SessionFactory sessionFactory = new MetadataSources( registry ).buildMetadata().buildSessionFactory();
	...
	public static void main(String[] args) {
		 ...
		 Cliente cliente1 = new Cliente (0,"eduardo","alvarez","pinto");
		 Cliente cliente2 = new Cliente (0,"ana","ortiz","mosquera");
		 Cliente cliente3 = new Cliente (0,"maria","carranza","mosquera");
         ...
         Pais pais2 = new Pais (0,"Mexico");
         Pais pais3 = new Pais (0,"Colombia");
